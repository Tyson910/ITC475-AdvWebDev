...
export default class RSVPform extends React.Component {
  ...
  handleChange(event) {
    ...
    if (event.target.type === 'radio') {
      ...
      let filteredOutingsArray = outingsArray.filter(x => x.isPicked === true); //sets IsPicked to true in chosen objects
  ...
  handleAll(event) {
    ...
    this.setState({
      numOfOutings: this.state.outings.length
    });
  }
  ...
  render() {
    ...
    let page2 = /*#__PURE__*/React.createElement("div", {
      ...
      style: pg2display
    }, /*#__PURE__*/React.createElement("h3", null, "Please select at least one activity"), /*#__PURE__*/React.createElement(MasterCheck, {
      isPicked: "false",
      selected: this.handleAll
